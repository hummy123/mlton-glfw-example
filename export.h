#ifndef __IMPORT_ML_H__
#define __IMPORT_ML_H__
...
#if !defined(PART_OF_IMPORT) && \
    !defined(STATIC_LINK_IMPORT) && \
    !defined(DYNAMIC_LINK_IMPORT)
#define PART_OF_IMPORT
#endif

#if defined(PART_OF_IMPORT)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_IMPORT)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_IMPORT)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for import
#define MLLIB_PRIVATE(x)
